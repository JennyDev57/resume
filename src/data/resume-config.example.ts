...
export const resumeConfig: ResumeConfig = {
  ...
  personal: {
    ...
    summary: {
      fr: "Développeusee fullstack avec 15 ans d’expérience, dont 3 ans sur React et TypeScript. À l’aise en équipe agile comme en autonomie, je mets mon savoir-faire au service de projets innovants, en concevant des applications performantes, évolutives et centrées utilisateur.",
